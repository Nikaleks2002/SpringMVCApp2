package nikita.ne.you.controllers;

import nikita.ne.you.dao.PersonDAO;
...
public class PeopleController {
    ...
    public String show(@PathVariable(value = "id", required = false) Integer id, Model model) {
        // Получим одного человека по его ид из DAO и передадим его на отображение в представление
